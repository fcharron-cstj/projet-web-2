...
Le festival demande la création d'une identité visuelle complète et d'un site web sur mesure. Le site doit offrir des fonctionnalités variées telles que la gestion des réservations, des forfaits, et des actualités, tout en étant facile à administrer.

## Demandes spécifiques des clients (dans vos mots/pas de copié-collé du devis)
Les clients demandent un site qui n'utilise pas de CMS préconçu, qui soit bien référencé, et qui offre une zone d’administration pour la gestion des utilisateurs et du contenu. Ils souhaitent aussi avoir des statistiques via Google Analytics, une carte interactive et des pages dynamiques pour la réservation de forfaits et la gestion des actualités.

### Besoins additionnels déterminés
Sécurisation des données des utilisateurs, base de données, interface intuitive pour les administrateurs, billetterie claire et attirante visuellement
...
### Besoins additionnels déterminés  
Un style qui sort de la norme, très coloré et captivant

## Public cible
Le public cible du site est composé des administrateurs, clients et futur clients. On vise une clientèle qui aime la musique, les arts visuels, les kiosques d'artisans et les expériences diversifiées.
...
## Thème 
Festival de musique et arts mettant de l'avant des artistes émergents dans un cadre innovant et interactif.
...
FEQ : Style visuel pour la page d'activités.

https://comediha.com/en/   https://lavoutemontreal.com/fr/accueil/     
https://muralfestival.com/   https://ilesoniq.com/en/experience   https://www.feq.ca/en/program

## Identité visuelle

### Le logo
Le nom Nova avec une typographie Brushberry pour créer un effet de peinture qui rappelle le côté artistique du festival, en bleu pour une couleur qui inspire confiance et de teinte néon pour représenter l'ambiance festival 
...
### Les typographies
Anchor: Anchor pour un effet un peu plus moderne, qui suit la rondeur des éléments et qui est distinctif.
...
## Forces
JavaScript offre des posibilités nombreuses pour aider au niveau technique et visuel
Laravel est bien structuré, sécurisé, et supporte bien la gestion d’utilisateurs et de contenu.
...
## Forces
Outil visuel facil à utiliser pour suivre les progrès.
...
GitHub pour travailler ensembles sur le projet 
...
https://chloe165.atlassian.net/jira/core/projects/PW2/list?sortBy=status&direction=ASC&atlOrigin=eyJpIjoiMmIzZGY3YTg1ZGE3NGNhMDkyOTg1MmMzNTg5YzkzMjEiLCJwIjoiaiJ9
...
#### Sous-catégories   
Recherche, Identité visuelle, Maquette
Intégration html, Scss, JS, Animations
Bdd, php
Référencement
